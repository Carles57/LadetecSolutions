...
import { faClock, faCalendar,faTimes, faUserClock, backward } from '@fortawesome/free-solid-svg-icons';
...
// Configura la zona horaria global al iniciar la app
//moment.tz.setDefault('America/Havana');
...
/*const formatDate = (date) => {
  // Usa moment-timezone para conversión precisa
  return moment(date).tz('America/Havana').format('YYYY-MM-DD');
};*/
        ...
        {loadingDetails ? (
          ...
          <div className="space-y-4">
            ...
            <div className="pt-4 mt-4 border-t">
              ...
              >
                <FontAwesomeIcon icon={backward} className="mr-2" />
  ...
  return (
    <div className="p-4 max-w-6xl mx-auto">
      ...
      <DatePicker
          ...
          //selected={selectedDate ? new Date(selectedDate) : null} // Convertir string a Date
         // onChange={handleDateChange}
          //dateFormat="yyyy-MM-dd"
