...
export default function UserList() {
  ...
  return (
    ...
    />
      ...
      {selectedUser ? (
        <div className="mt-2">
          <h2 className="text-2xl font-bold pt-2 mb-4 text-center">Detalles del usuario</h2>
        ...
        <div className="mt-2">
          ...
          >
            <div className="mb-4">
              <label htmlFor="username" className="block font-bold mb-2 italic">
                Usuarios
              </label>
              <input
                  ref={inputRef}
        ...
        <>
         <div className="mb-4 flex justify-between italic">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 h-[600px]">
              ...
              <table className="w-full min-w-[500px]">
                <thead className="sticky top-0 bg-gray-100">
                  <tr>
                    ...
                    <th className="p-2 text-sm border-b">Usuarios</th>
            ...
            <div className="hidden md:flex h-full min-h-[300px] rounded-lg overflow-hidden border border-gray-200 shadow-lg bg-gray-100">
  <img 
    src="images/ladetec.jpg" 
